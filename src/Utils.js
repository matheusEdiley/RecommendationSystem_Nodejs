 ...
 * @return: object: ...
 **/
exports.functionTeste = () => {
    console.log("Teste");
}

let stopWords = "a,à,agora,ainda,alguém,algum,alguma,algumas,alguns,ampla,amplas,amplo,amplos,ante,antes,ao,aos, \
